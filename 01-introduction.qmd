...
The two readers want different things from the same page, and naming the tension makes it manageable. @tbl-audiences contrasts what each brings and what each needs; the chapters aim to let either reader follow their own thread without having to abandon the other's.
