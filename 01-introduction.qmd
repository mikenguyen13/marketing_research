...
**Unstructured and Multimodal Data.** Most marketing data does not arrive as a tidy table. This part takes the unstructured modalities in turn: text as data (@sec-text-as-data)—together with the figurative language, such as sarcasm, that breaks naïve text pipelines (@sec-sarcasm)—images (@sec-image-processing), and, as the part grows, audio and voice, video, and the multimodal foundation models that represent them jointly.
