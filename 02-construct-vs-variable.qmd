...
: Reflective vs. formative measurement models and their consequences for assessment.
...
: Decision errors induced by an imperfect measure. Reliability and validity shortfalls translate into Type I and Type II error rates; which error dominates depends on where the decision threshold sits relative to the construct distribution.
