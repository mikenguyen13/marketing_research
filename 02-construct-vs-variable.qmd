...
::: callout-note
## Controversy: how much does common method bias actually matter?

Method bias is one of the most-invoked objections in marketing review reports, and the field has never fully agreed on how seriously to take it. The disagreement is on the record, and it is worth reading in sequence.

**2003 — the canonical statement.** @podsakoff2003commonmethod review the literature and set out the procedural and statistical remedies that become standard practice. The paper goes on to be cited tens of thousands of times, and "common method bias" enters the reviewer's standard repertoire.

**2012 — a target article, and two commentaries in the same issue.** @mackenzie2012cmb restate the case for marketing specifically in the *Journal of Retailing*, laying out causes, mechanisms, and procedural remedies. The journal publishes two commentaries immediately following it. @viswanathan2012commentary respond across six pages; @baumgartner2012commentary respond across four. Both appear in the same issue as the target article, at pages 556 and 563 to its 542.

The structure is the point. This is not a critique published years later in another outlet — the journal solicited disagreement and printed it adjacent to the argument, so a reader encounters the objection in the act of reading the claim. It is a design a field can adopt deliberately, and marketing does so more often than most.

What a doctoral reader should take from it is narrower than "method bias is or is not real." The remedies divide into procedural ones, which change how data are collected, and statistical ones, which attempt to partition method variance after the fact. The procedural remedies are uncontroversial and underused. The statistical remedies rest on assumptions about which variance is method variance that cannot be tested from the contaminated data—the point made in the footnote above. A reviewer who demands a marker-variable correction is asking for something weaker than a reviewer who asks why predictor and outcome were measured from the same respondent at the same moment.
:::
