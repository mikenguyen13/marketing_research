...
Table by professor Venky Shankar

+------------------------------+----------------------+-----------------------+
| Exchange Interrelationship / | Cost Reduction       | Value Addition        |
|                              |                      |                       |
| Orientation                  |                      |                       |
+==============================+======================+=======================+
| Low                          | Procurement exchange | Supply chain exchange |
+------------------------------+----------------------+-----------------------+
| High                         | Procurement web      | Networked web         |
+------------------------------+----------------------+-----------------------+
|                              |                      |                       |
+------------------------------+----------------------+-----------------------+

more and more firms use mobile apps

market-shakeouts and winners take all

open exchanges are the new trend

domain expertise is more important

Vertical-exchange + Horizontal exchange = competitive advantage
