...
Most of the examples are taken from `philentropy` package in R, which can be accessed via this [link](https://cran.r-project.org/web/packages/philentropy/vignettes/Information_Theory.html)

#### Discrete Entropy

If $\mathbf{p}_X = (p_{x1},p_{x2},...,p_{xn})$ is the probability distribution of the discrete random variable X with $P(X = x) = p_{xi}$. Then, the **entropy** of the distribution is [@Shannon_1948]
...
Entropy is the measure of how much information gained from learning the value of X [@Zwillinger_1995, pp.262]. Entropy depends on the distribution of X.
...
<img src="23-communication_files/figure-html/unnamed-chunk-1-1.png" width="672" />
...
Three metrics for divergence can be found [here](https://cran.r-project.org/web/packages/philentropy/vignettes/Information_Theory.html):
