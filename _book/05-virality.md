...
1.  S-shaped could result from different processes that are not contagion
    ...
    1.  Population heterogeneity [@Chatterjee_1990]

    2.  Marketing efforts [@Van_den_Bulte_2001]
...
**Viral is different from Popular** [@Goel_2015]
...
<br> Hence the process of information acquisition would induce to talk more about
...
### Persuading others {#persuading-others}
...
[@Lisjak_2021] defined contractuality as " the extend to which a perk is perceived to be conditional on specific behaviors and contingencies dictated by a company."
...
-   Locus of control is defined as "individuals' general and daily expectancies about the causes of their reward and punishment [@lam2005, pp. 216], consisting of internal (i.e., one can control his or her lives) and external (i.e., external factors can control their lives such as luck, or fate).

    -   Internals tended to be more educated [@lachman1989], higher household incomes [@hoffman2003], men and those in senior positions [@smith1997]. Internals are more action-oriented, risk-taking.
...
-   Vertical (i.e., emphasizing hierarchy) and horizontal (i.e., emphasizing equality) dimensions of individualism and collectivism (HVIC) [@singelis1995]

    -   opinion leadership: "the tendency that an individual attempts to influence the decisions of others by giving his or her opinion about products, services, or firms" [@choi2019, pp. 294]

        -   socially appropriate (horizontal orientation)

        -   show off knowledge (vertical orientation)

    -   opinion seeking "the tendency that an individual seeks information or opinions from more knowledgeable others to find out about and/or evaluate products or services" [@choi2019, pp. 294]

        -   well-informed decisions (individualism)

        -   find values and beliefs of the reference group (collectivism)

    -   Horizontal individualism is "a cultural pattern where an autonomous self is postulated but the individual is more or less equal in status with others" [@singelis1995, pp. 245]

    -   Vertical individualism is "a cultural pattern in which an autonomous self is postulated, but individuals see each other as different, and inequality is expected" [@singelis1995, pp. 245].

    -   Horizontal collectivism is "a cultural pattern in which the individual sees the self as an aspect of an in-group" [@singelis1995, pp. 244].

    -   Vertical collectivism is "a cultural pattern in which the individual sees the self as an aspect of an in-group, but the members of the in-group are different from each other, some having more status than others" [@singelis1995, pp. 244].

-   Collectivist culture will have greater levels of opinion seeking, whereas individualist culture has greater information-giving.[@fong2008]
...
-   Empirical evidence
    ...
    -   contagion in consumer packaged goods [@Du_2011]
