...
[@erdem1996a] is a good paper to think of structural modeling in marketing
    ...
    1.  Firm differentiation
        ...
        -   Firm strategy
            ...
            -   Entry timing:
                ...
                -   Late entry: pioneers usually don't have long-term success [@golder1993], learn lesson from early entrants, lower learning curve
        ...
        -   Firm resources: Firm size
            ...
            -   Smaller \> larger: less bureaucracy, which lower innovative ability [@chandy2000]
...
+-------------------+-------------------------------------------------------------------+----------------------------------------------------+
| Entry mode        | 6 points scale based on [@anderson1986]                           | Archival data                                      |
+-------------------+-------------------------------------------------------------------+----------------------------------------------------+
...
+-------------------+-------------------------------------------------------------------+----------------------------------------------------+
| Economic distance | [@mitra2002]                                                      | International Financial Statistics yearbook        |
+-------------------+-------------------------------------------------------------------+----------------------------------------------------+
| Cultural distance | Follow [@kogut1988]                                               | Hofstede (1991, 2001)                              |
+-------------------+-------------------------------------------------------------------+----------------------------------------------------+
| Openness          | Fraction of foreign direct investment over the host country's GDP | International Monetary Fund                        |
+-------------------+-------------------------------------------------------------------+----------------------------------------------------+
| Country Risk      | Based on International Country Risk Guide [@erb1996]              | International Country Risk Guide                   |
+-------------------+-------------------------------------------------------------------+----------------------------------------------------+
...
#### [@chandrasekaran2007] A review of new products diffusion
...
$$
t^* = \frac{1}{p + q} \times \ln (\frac{q}{p}) \\
S(t)^* = m \times \frac{(p + q)^2}{4q}
$$
...
[@bass1994] incorporate both price and promotion to the Generalized Bass model
...
$$
\frac{d A(t)}{dt} = [p + \frac{q_1}{m}A(t) + \frac{q_2}{m} N(t)][ m - A(t) - N(t) ] - c(t) A(t) \\
= \text{[Waiting population + Adopters] - conversion rate of applicants to adopters}\\
$$
...
$$
\frac{d Z(t)}{dt} = \frac{d A(t)}{dt}  + \frac{dN(t)}{dt} \\
= (p + \frac{q_1}{m} A(t) + \frac{q_2}{m} N(t) ) (m - A(t) - N(t))
$$

To incorporate waiting applicants abandoning their adoption decision after some time see [@ho2002]
...
Leapfrogging behavior is possible (i.e., skip a generation to buy the next one) [@mahajan1996]

-   **Incorporate time-varying parameters**

    -   Model market potential ($m$) as a function of time-varying exogenous and endogenous variables [@mahajan1978]

    -   Model coefficient of imitation to be time-varying [@easingwood1983]
...
Different adopters could influence later adopters differently (people who adopted more recently are more vocal) [@sharma1994a]
...
[@steffens2003a] models multiple units purchase by a single household.
...
-   MLE: avoid time-interval bias, but underestimates the SE [@schmittlein1982]

-   Non linear least squares: [@srinivasan1986] need lots of obs
...
-   Hierarchical Bayesian method
    ...
    -   Problem with definition of similar products (fixed by [@bayus1993] with product segmentation scheme)

-   Adaptive techniques: stochastic techniques (parameter vary over time) ([@xie1997]augmented Kalman filter)
...
-   Alternative drivers:
    ...
    -   Affordability: [@golder1998] model as Cobb-Douglas model:
        ...
        -   [@horsky1990] incoproates both price and income and WOM on sales growth.

    -   Heterogeneity: aggregate level diffusion models: [@roberts1988b], [@oren1988], [@Chatterjee_1990], [@bemmaor1984] [@song2003], [@sinha1992] [@karshenas1993]

    -   Strategy: model supply side: (market entry, marketing mix, location) [@dekimpe2000a], [@Van_den_Bulte_2001],[@bronnenberg2004]

-   Alternative phenomena:

    -   Spatial diffusion [@mahajan1979], [@redmond2003], [@garber2004]
    ...
    -   Diffusion of entertainment products: follow exponential decay [@eliashberg1994], [@eliashberg2000], [@elberse2003], [@moe2002], [@lee2003]

Modeling the turning points in diffusion

-   Takeoff: follow [@golder1997] definition: "point of transition from the introduction stage to the growth stage"

    -   Measurement

        -   [@golder1997]: threshold takeoff (compare to other in the categories)
        ...
        -   [@agarwal2002a] measure based on annual percentage change in sales

        -   [@stremersch2004] adapted the threshold method for international markets

        -   [@garber2004] rule of thumb: 10-20 market penetration

    -   Drivers

        -   [@golder1997] price declines lead to takeoff

        -   [@agarwal2002a] increase in firm entry lead to better product quality, marketing infrastructures

        -   [@tellis2003] venturesome culture lead to takeoff

    -   Model: either proportional hazards [@golder1997] or log-logistic hazard [@tellis2003]

    -   Evaluation: Only model successful innovation so far.

-   Slowdown: point of transition from the growth stage to the maturity stage [@golder1997]

    -   Measurement: [@golder2004] "operationalize as the first year of two consecutive years after takeoff in which sales are lower than the highest previous sales." (p.72)

    -   Explanation:

        -   Dual-market phenomenon: early adopters vs. early majority [@goldenberg2001]

        -   Informational cascades: negative cascades [@golder2004]

        -   Affordability[@golder2004]

    -   Modeling:

        -   Cellular automata models: [@goldenberg2001]

        -   Hazard models: [@golder2004]
...
-   Definitions:
    ...
    -   Models: based on [@norton1987]

$$
S_1 (t) = m_1 F_1(t) (1- F_{12}(t- \tau_2 + 1)) \\
S_2 (t) = F_2(T- \tau_2 + 1) (m_2 + m_1 F_1(t))
$$
...
$$
\sum_{i = 1}^n (s_{i1} - m_1 F_1(t_i)) (1 - F_{12} (t_i - \tau_2 + 1))^2 \\
+ \sum_{i=1}^n (s_{i2} - F_2 (t_i - \tau_2 + 1)(m_2 + m_1F_1(t_i)))^2
$$
...
#### [@prins2007] Marketing effects on adoption timing
...
-   Adoption timing is defined as "the time between the introduction and the adoption of the new service" (p. 170) following [@steenkamp2003a]
...
-   [@donkers2003] demonstrates that if oversampling is not accompanied by stratfied sampling on the independent variables, it should not affect the parameter estimates or SE for are event in binnary choice models.
...
### [@chandy2000] Incumbent's curse

-   Present this paper
-   Definition: "A radical product innovation is a new product that incorporates a substantially different core technology and provides substantially higher customer benefits relative to previous products in the industry" [@chandy1998].
...
### [@tellis2003] International Takeoff
...
### [@hauser2006]Review on Innovation
...
### [@chandrasekaran2008] Global Takeoff

-   16 products in 31 countries

-   Parametric hazard model

-   Economic variable (developed vs. developing) (isn't this kinda contradict [@tellis2003], product types (work vs. fun), cultural clusters, calendar time can affect takeoff time

-   Takeoff is getting shorter over time

### [@sood2011] Predict takeoff

### [@zhang2016] Restaurant survival from Yelp
...
Using [@koyck1954distributed] model captures carryover
...
$$
\begin{aligned}
S_t - \lambda S_{t-1} &= \alpha - \alpha \lambda + \beta A_t + \epsilon_t - \epsilon_t \lambda \\
S_t &= \alpha - \alpha \lambda + \lambda S_{t-1} + \beta A_t + \epsilon_t - \epsilon_t \lambda \\
S_t &= \alpha + \lambda S_{t-1} + \beta A_t + u_t
\end{aligned}
$$
...
[@clarke1976] found major limitation of Koyck model
...
-   People used to think the best data interval time is the inter-purchase time. But [@tellis2006] showed that unit exposure time is the optimal data interval (the smallest interval within which advertising occurs only once and at the same time every period)
...
### [@tellis2006] Optimal Data Interval for estimating ad response (on sales)
...
Using [@koyck1954distributed] transformation (i.e., multiply both sides by $1 - \lambda L$ where $L$ is the familiar lag operator $L^k y_t = y_{t-k}$) then
...
$$
\begin{aligned}
S_T &= s_t + s_{t-1}+ s_{t-2}+ \dots + s_{t-(K-1)} \\
& = (1 + L + L^2  + \dots + L^{K-1})s_t
\end{aligned}
$$
...
$$
A_T = (1 + L + L^2  + \dots + L^{K-1}) a_t \\
\epsilon_T = (1 + L + L^2  + \dots + L^{K-1}) \epsilon_t \\
S_{T-1} = (1 + L + L^2  + \dots + L^{K-1}) s_{t-K}
$$

The true aggregate form of the micromodel

$$
S_T = \lambda^K S_{T-1} + \beta A_T + \beta \lambda (1 + \lambda L + \lambda^2 L^2 + \dots + \lambda^{K-1} L^{K-1}) \\
\times (1 + L + \dots + L_{K-1})a_{t-1} + \epsilon_T - \lambda^K \epsilon_{T-1}
$$

The bias stem from the fact that

$$
A_{T-1} \neq (1 + \lambda L + \lambda^2 L^2 + \dots + \lambda^{K-1} L^{K-1}) \\
\times (1 + L + \dots + L_{K-1})a_{t-1} 
$$
...
### [@teixeira2010] Ad Pulsing to prevent consumer ad avoidance
...
### [@sethuraman2011] Advertising effectiveness meta-analysis
...
### [@liaukonyte2015] TV advertising on online shopping
...
### [@tirunillai2017] TV ad on Online chatter: synthetic control
...
### [@fornell2006] Customer satisfaction and stock return
...
$$
\ln Market value = \alpha + \beta_1 \ln Book value \\
+ \beta_2 \ln Bookvalueliability + \beta_3 \ln ACSI
$$
...
-   estimation period = 255 days ending 46 days before the event date [@mcwilliams1997a]
...
### [@srinivasan2009] Marketing and Firm Value
...
-   Market is not so efficient: e.g.
    ...
    -   Intangible-intensive firms are usually undervalued [@lev1989]
...
+=============================+==================================================================================================================================================================+===================================================+==================================+=================================================+
| Four Factor Model           | Assume efficient market theory                                                                                                                                   | sensitive to benchmark portfolio                  | [@Rao_2004]                      | Tobin's q/ Branding strategy                    |
|                             |                                                                                                                                                                  |                                                   |                                  |                                                 |
|                             |                                                                                                                                                                  | correlation analysis                              | [@barth1998brand]                | Firm val/ brand value estimates                 |
|                             |                                                                                                                                                                  |                                                   |                                  |                                                 |
|                             |                                                                                                                                                                  | can contain omitted variable bias                 | [@madden2002]                    | Stock returns/ brand valuation                  |
|                             |                                                                                                                                                                  |                                                   |                                  |                                                 |
|                             |                                                                                                                                                                  | examine cross-sectional variation only            |                                  |                                                 |
+-----------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------+---------------------------------------------------+----------------------------------+-------------------------------------------------+
| Event Study                 | Assume efficient market                                                                                                                                          | can't measure long-term effect                    | [@horsky1987]: name change       | Stock returns/ name events                      |
|                             |                                                                                                                                                                  |                                                   |                                  |                                                 |
|                             | Causal Analysis                                                                                                                                                  |                                                   | [@chaney1991]: new product intro | Stock returns/ new product intro                |
|                             |                                                                                                                                                                  |                                                   |                                  |                                                 |
|                             |                                                                                                                                                                  |                                                   | [@lane1995]: brand extension     | Stock returns/ brand extensions                 |
|                             |                                                                                                                                                                  |                                                   |                                  |                                                 |
|                             |                                                                                                                                                                  |                                                   | [@geyskens2002]                  | Stock returns/ Internet channel                 |
+-----------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------+---------------------------------------------------+----------------------------------+-------------------------------------------------+
| Calendar protfolio          | Include firms with certain to measure long-term impact                                                                                                           | Can't measure per event effect                    | [@sorescu2007]                   | Stock returns/ new product                      |
|                             |                                                                                                                                                                  |                                                   |                                  |                                                 |
|                             | more accurate than event studies                                                                                                                                 | might be sensitive to benchmark prtofolio         |                                  |                                                 |
+-----------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------+---------------------------------------------------+----------------------------------+-------------------------------------------------+
| Stock return response model | based on Carhart (1997) and EMH                                                                                                                                  | detailed data at the brand so business unit level | [@aaker1994]                     | Stock returns/ perceived quality                |
|                             |                                                                                                                                                                  |                                                   |                                  |                                                 |
|                             | account dynamic properties of stock returns                                                                                                                      | marketing info must be public                     | [@aaker2001]                     | Stock return / brand attitude                   |
|                             |                                                                                                                                                                  |                                                   |                                  |                                                 |
|                             | incorporate continuous events                                                                                                                                    | single equation model without temporal chain      | [@mizik2003]                     | stock return/ strategic shifts                  |
|                             |                                                                                                                                                                  |                                                   |                                  |                                                 |
|                             |                                                                                                                                                                  |                                                   | [@srinivasan2009a]               | Stock returns/ marketing actions                |
+-----------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------+---------------------------------------------------+----------------------------------+-------------------------------------------------+
| Persistence modeling        | system of equations: consumer (demand equation), manager (decision rule equation), competition, (competitive reaction equation), investor (stock price equation) | detailed data at the business unit level          | [@pauwels2018]                   | Firm value/ new product intro, sales promotions |
|                             |                                                                                                                                                                  |                                                   |                                  |                                                 |
|                             | VAR: examines both short-term and long-term                                                                                                                      | time-series over a long horizon                   | [@joshi2010]                     | stock returns/ advertising                      |
|                             |                                                                                                                                                                  |                                                   |                                  |                                                 |
|                             | robust to deviations from stationarity                                                                                                                           | reduced-form models                               |                                  |                                                 |
|                             |                                                                                                                                                                  |                                                   |                                  |                                                 |
...
![Figure 1: Flow chart of return and risk p. 297)](images/return%20and%20risk.PNG)

4 factor model:

$$
R_{it} - R_{rf,t} = \alpha_i + \beta_i (R_{mt} - R_{rf,t}) + s_i SMB_t \\
h_i HML_t + u_i UMD_t + \epsilon-{it}
$$
...
### [@sood2009a] Innovation and Stock Return
...
-   Disagreeing with previous research conclusion that there was a systemic mispricing of customer satisfaction into the stock price [@fornell2006] [@aksoy2008], the anomaly stem from only a small group of satisfaction leaders in the computer and internet sector. (i.e., sampling bias).

-   This study is consistent with [@osullivan2009]

### [@jacobson2009a]

### [@borah2014] Choice of Payoff from announcements (Innovations)
...
### [@tirunillai2012] Chatter effect on stock performance
...
$$
R_{i,t} - R_{f,t} = \alpha_i + \beta_{i, MKT} (R_{MKT, t} - R_{f,t}) + \beta_{i, SMB} SMB_t \\
+ \beta_{i, HML} HML_t + \beta_{i, MOM} MOM_t  + \epsilon_{i,t}
$$
...
$$
\ln(\sigma^2_{i,t} ) = a_i + \sum_{j = 1}^p b_{i,j} \ln (\sigma^2_{i,t-j}) \\
+ \sum_{k=1}^q c_{i,k}\{ \Theta (\frac{\epsilon_{i, t - k}}{\sigma_{i, t - k}}) + \Gamma (| \frac{\epsilon_{i, t-k}}{\sigma_{i, t-k}}| - (\frac{2}{\pi})^{1/2})\}
$$
...
-   New product Announcement: also LexisNexis and Factiva (following [@sood2009])
...
### [@bayus2013] Crowdsourcing New Product Ideas over Time
...
-   Negative effect of past success can be mitigated for idators with more diverse commenting activity
    ...
    -   Fixation effect = unconscious plagiarism (or cryptomnesia) [@marsh1995] [@marsh1999]
...
### [@toubia2017] Idea generation, creativity, prototypicality
...
### [@wei2021] Machine leaning creativity
...
### [@berger2018] Content Atypicality

-   Ideas are better if they are different from other in the same contest.

### [@stephen2016] The Effects of Network Structure on Redundancy of Ideas
...
-   Quality: attribute on which all (most) consumers prefer more to less (e.g., speed, reliability, durability, power). [@tellis1987]

-   Market for quality [@klein1981]: why quality commands a premium
...
-   Solutions:
    ...
    -   [@kopalle1992]: ranking products on quality not too noisy even if the weights are uncorrelated. but you still need attributes of quality to be positively correlated.

    -   [@tellis2007]: expert reviews: published quality ratings are good indicator of quality

    -   [@tirunillai2014a]: wisdom of the crowds

### [@tellis2009] Network effects and quality in high tech
...
### [@golder2012] An Integrative Framework for Quality
...
### [@tirunillai2014a] Mining Quality from Consumer Reviews

-   use unsupervised LDA to measure quality dimensions in UGC

-   Data: 350,000 consumer reviews from [@tirunillai2012]
...
### [@borah2016] Spillover Effects in Social Media
...
-   Based on the accessibility-diagnosticity theory by [@feldman1988], one brand's perceptions can be used to make inference aobut another brand's perception if they are simialrin the consumer's mind.
...
-   Measures of endogenous variables
    ...
    -   Media citations: in print media per day on LexisNexis with 60% relevancy score (similar to [@tirunillai2012]
