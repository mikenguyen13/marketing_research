...
<!--chapter:end:02-advertising.Rmd-->

# Brand Equity

<!--chapter:end:03-brand_equity.Rmd-->

# Celebrity Endorsement

Based on [Power Distance Theory](https://bookdown.org/mike/social-theory/power-distance-theory.html), power distance beliefs moderates the positive effect of celebrity endorsers on evaluations of advertising [@Winterich_2018]

<!--chapter:end:04-celebrity_endorsement.Rmd-->
...
<!--chapter:end:07-advertising.Rmd-->
