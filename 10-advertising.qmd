...
@fich2024target Target Firm Advertising Effect on Firm Value

-   Targets with pretakeover advertising achieve higher premiums and greater negotiating power, while acquirers see lower announcement returns.

-   Advertising increases targets' chances of initiating takeovers, attracting multiple bidders, receiving higher bids, and securing more merger rents; even failed acquisitions lead to a 1% permanent value gain for targets.

-   Findings support that target firms use advertising to communicate valuable information to investors and potential acquirers, boosting profile and attractiveness in the market.
...
[@shapiro2021tv] TV Advertising Effectiveness and Profitability

-   **Objective**: Estimate the distribution of TV advertising elasticities and ROI across diverse product categories.

-   **Key Findings**:

    -   Detected smaller advertising elasticities than literature benchmarks.

    -   A significant portion of estimates were statistically insignificant or negative.

-   **Methodology Robustness**:

    -   Results consistent across functional form assumptions.

    -   Findings not attributed to insufficient statistical power or measurement errors.

-   **ROI Insights**:

    -   Over 80% of brands showed negative marginal ROIs, indicating potential over-advertising.

    -   Just 1/3 of brands had a positive ROI from their observed advertising schedule.
